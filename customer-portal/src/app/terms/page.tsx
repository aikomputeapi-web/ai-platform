    ...
    <div className="min-h-screen" style={{ background: 'var(--color-bg-primary)' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        {[
          ...
          { title: '9. Intellectual Property', body: 'The Service and its original content remain the exclusive property of aikompute. Your use of the Service does not grant you ownership of any intellectual property rights in the Service or its content.' },
          { title: '10. Limitation of Liability', body: 'To the fullest extent permitted by law, aikompute shall not be liable for any indirect, incidental, special, or consequential damages resulting from your use of the Service, including but not limited to loss of profits, data, or business.' },
